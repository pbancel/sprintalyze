...
<head>
    <meta charset="utf-8">
    <title>Jira OAuth Callback - Sprintalyze</title>
            ...
            <div class="static-content">
                <div class="page-content">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="{{ route('jira.connect') }}">Jira Connect</a></li>
                        <li class="active">OAuth Callback</li>
                    </ol>
                    <div class="page-heading">
                        <h1>Jira OAuth Callback<small>Processing your authorization</small></h1>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body text-center">
                                        ...
                                        <p class="mt-lg">Processing your Jira authorization...</p>

                                        @if(isset($code))
                                            <p class="text-muted mt-md">Authorization code received</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
